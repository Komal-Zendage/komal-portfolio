      ...
      <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='md:w-1/2 mb-10 md:mb-0 ml-10'>
          ...
          <p className='text-lg text-gray-300 mb-8'>
            I create modern, scalable web experiences with innovative design and <br />modern technologies.
          </p>
          <div className='space-x-4'>
            <a
              href="/komalzendage_Resume.pdf" // <- public folder
              download
            ...
            <a
              href="#contact"
              className='px-4 py-2 border border-purple rounded-lg font-medium hover:bg-purple/20 transition duration-300'
            >
              Contact Me
            </a>
          </div>
          ...
          <div className='relative w-64 h-64 md:w-80 md:h-80'>
            <div className='absolute inset-0 rounded-full bg-gradient-to-r opacity-70'>
              <motion.img
                ...
                src="/profileImg.png" // <- public folder
                alt="Profile"
              />
            </div>
          </div>
