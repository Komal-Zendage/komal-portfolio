...
import resume from "/komalzendage_Resume.pdf";
      ...
      <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='md:w-1/2 mb-10 md:mb-0 ml-10'>
          ...
          <div className='space-x-4'>
            ...
            <a href="#contact" className='px-4 py-2 border border-purple rounded-lg font-medium hover:bg-purple/20 transition duration-purple-300'> Contact Me</a>
